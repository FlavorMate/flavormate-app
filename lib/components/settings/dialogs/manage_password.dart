...
class _ManagePasswordState extends State<ManagePassword> {
  ...
  Widget build(BuildContext context) {
    return TAlertDialog(
      title: L10n.of(context).d_settings_manage_password_title,
      scrollable: true,
      submit: apply,
      child: Form(
        key: _formKey,
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                label: Text(L10n.of(context).d_settings_manage_password_old),
              ),
              obscureText: true,
              validator: (value) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                border: const OutlineInputBorder(),
                label: Text(L10n.of(context).d_settings_manage_password_new),
              ),
              obscureText: true,
              validator: (value) {
                if (UValidator.isEmpty(value)) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                border: const OutlineInputBorder(),
                label: Text(L10n.of(context).d_settings_manage_password_new_2),
              ),
              obscureText: true,
              validator: (value) {
                if (UValidator.isEmpty(value)) {
