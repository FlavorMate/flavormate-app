...
import 'package:flavormate/data/repositories/features/websockets/common/p_socket_common_highlights.dart';
...
class PRestHighlights extends _$PRestHighlights {
  ...
  Future<PageableDto<HighlightDto>> build(
    ...
    // If new highlight is generated by server, refresh
    ref.watch(pSocketCommonHighlightsProvider);
