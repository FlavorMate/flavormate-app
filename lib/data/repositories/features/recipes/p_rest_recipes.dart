...
import 'package:flavormate/data/repositories/features/websockets/common/p_socket_common_recipes.dart';
...
class PRestRecipes extends _$PRestRecipes {
  ...
  Future<PageableDto<RecipePreviewDto>> build(
    ...
    // If new recipe is generated by server, refresh
    ref.watch(pSocketCommonRecipesProvider);
