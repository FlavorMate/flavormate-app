...
abstract class UImage {
  static String resize360p(Uint8List bytes) {
    return resizeImage(bytes: bytes, width: 640, height: 360);
  }

  static String resize720p(Uint8List bytes) {
    return resizeImage(bytes: bytes, width: 1280, height: 720);
  }

  static String resize1080p(Uint8List bytes) {
    return resizeImage(bytes: bytes, width: 1920, height: 1080);
  }
  ...
  static Uint8List resizeImageRaw({
    required Uint8List bytes,
    required int width,
    required int height,
    int blur = 15,
    ...
    img.adjustColor(canvas, brightness: 0.6);
