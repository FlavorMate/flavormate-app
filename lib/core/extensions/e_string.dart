extension EString on String {
  ...
  /// String shorFText = text.shorten(length: 20);
  /// print(shorFText); // Output: "This is a long..."
  /// ```
...
extension ENullableString on String? {
  bool get isBlank => this?.trim().isEmpty ?? true;

  bool get isNotBlank => !isBlank;

  String get trimToBlank => isBlank ? '' : this!.trim();

  String? get trimToNull => isBlank ? null : this!.trim();
}
