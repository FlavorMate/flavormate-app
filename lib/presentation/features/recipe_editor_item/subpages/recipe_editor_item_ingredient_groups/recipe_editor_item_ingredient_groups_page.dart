...
class RecipeEditorItemIngredientGroupsPage extends ConsumerStatefulWidget {
  const RecipeEditorItemIngredientGroupsPage({
    super.key,
  ...
  PRecipeEditorItemIngredientGroupsProvider get provider =>
      pRecipeEditorItemIngredientGroupsProvider(draftId);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _RecipeEditorItemIngredientGroupsPageState();
}

class _RecipeEditorItemIngredientGroupsPageState
    extends ConsumerState<RecipeEditorItemIngredientGroupsPage> {
  ...
  Widget build(BuildContext context) {
    return FProviderPage(
      ...
      floatingActionButtonBuilder: (_, _) => M3EExtendedFab(
        ...
        label: context.l10n.recipe_editor_item_ingredient_groups_page__create,
  ...
  double calcProgress(List<RecipeDraftIngredientGroupDto> groups) {
