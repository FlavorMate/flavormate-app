...
class AccountsItemStoriesPage extends ConsumerStatefulWidget {
  ...
  String get pageKey => PageableState.tags.name;
      ...
      body: SafeArea(
        child: FProviderState(
          ...
          onEmpty: FEmptyMessage(
            title: context.l10n.accounts_item_stories_page__on_empty,
            icon: StateIconConstants.stories.emptyIcon,
          ),
          onError: FEmptyMessage(
            title: context.l10n.accounts_item_stories_page__on_error,
                  ...
                  slivers: [
                    FPageIntroductionSliver(
                      ...
                      description: context.l10n
                          .accounts_item_stories_page__description(
                            account?.displayName ?? '',
                          ),
                    ),
