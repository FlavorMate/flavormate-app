...
var routes = [
      ...
      StatefulShellBranch(
        routes: [
          GoRoute(
            path: '/more',
            pageBuilder: (context, state) =>
                const MaterialPage(child: MorePage()),
          ),
        ],
      ),
      StatefulShellBranch(
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) =>
        const MaterialPage(child: UserManagementPage()),
  ),
  GoRoute(
    path: '/no-connection',
    name: 'no-connection',
    pageBuilder: (context, state) =>
        const MaterialPage(child: NoConnectionPage()),
  ),
  GoRoute(
  ...
  GoRoute(
    ...
    name: 'recipe-drafts',
    pageBuilder: (context, state) =>
        const MaterialPage(child: RecipeDraftsPage()),
  ),
  GoRoute(
    path: '/recovery',
    name: 'recovery',
  ...
  GoRoute(
    ...
    name: 'story-drafts',
    pageBuilder: (context, state) =>
        const MaterialPage(child: StoryDraftsPage()),
  ),
  GoRoute(
